class FluxxCrmCreateUsers < ActiveRecord::Migration
  def self.up
    ...
    add_foreign_key 'users', 'personal_country_id', 'geo_countries', 'id', 'users_personal_country_id'
    add_foreign_key 'users', 'personal_geo_state_id', 'geo_states', 'id', 'users_personal_geo_state_id'
    add_foreign_key 'users', 'primary_user_organization_id', 'user_organizations', 'id', 'users_primary_user_org_id'
  end
