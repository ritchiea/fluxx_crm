class FluxxCrmCreateUserOrganizations < ActiveRecord::Migration
  def self.up
    ...
    add_foreign_key 'user_organizations', 'user_id', 'users', 'id', 'user_org_user_id'
    add_foreign_key 'user_organizations', 'organization_id', 'organizations', 'id', 'user_org_org_id'
  end
