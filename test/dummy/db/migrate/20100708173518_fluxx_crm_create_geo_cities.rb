class FluxxCrmCreateGeoCities < ActiveRecord::Migration
  def self.up
    ...
    add_foreign_key 'geo_cities', 'geo_state_id', 'geo_states', 'id', 'geo_cities_state_id' unless connection.adapter_name =~ /SQLite/i
    add_foreign_key 'geo_cities', 'country_id', 'countries', 'id', 'geo_cities_country_id' unless connection.adapter_name =~ /SQLite/i
